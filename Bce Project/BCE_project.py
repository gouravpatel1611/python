...
# ------------ PRINTING Rise and Fall TABLE  -------------------------------------------------   
print("\n") 
print(" \t \t ~~ Rise and Fall Table ~~")
print("---------|---------|---------|---------|---------|---------|---------|--------|")
print ("{:<8} | {:<7} | {:<7} | {:<7} | {:<7} | {:<7} | {:<7} | {:<7}|".format("Station","BS","IS","FS","RISE","Fall","RL","Remark"))   
print("---------|---------|---------|---------|---------|---------|---------|--------|")
...
for item in table_list:
    ...
    table_is  = str(item['IS'] )[0:6]
    table_fs  = str(item['FS'] )[0:6]
    table_r  = str(item['RISE'] )[0:6]
    table_f  = str(item['FALL'] )[0:6]
    table_rl  = str(item['RL'] )[0:7]
    table_rm  = str(item['Remark'])
    
    print ("{:<8} | {:<7} | {:<7} | {:<7} | {:<7} | {:<7} | {:<7} | {:<7}|".format(station,table_bs,table_is,table_fs,table_r,table_f,table_rl,table_rm))
    print("---------|---------|---------|---------|---------|---------|---------|--------|")
